...
module.exports = {
    ...
    run: async(client, interaction, args) => {
        try {
            ...
            if (!arg) return interaction.followUp(emojis.error + ' | **Can\'t Find The Ticktok Url**')
                                                                        ...
                                                                        collector.on("collect", async(i) => {
                                                                            ...
                                                                            if (i.customId == "video") {
                                                                                ...
                                                                                let videoRow = new MessageActionRow()
                                                                                    .addComponents(btn);
                                                                                let videoMessage = await interaction.editReply({
                                                                                    embeds: [
                                                                                        embed
                                                                                    ],
                                                                                    components: [videoRow]
                                                                                ...
                                                                                let playRow = new MessageActionRow()
                                                                                    .addComponents(btn);
                                                                                let musicMessage = await interaction.editReply({
                                                                                    embeds: [
                                                                                        embed
                                                                                    ],
                                                                                    components: [playRow]
                                                                                ...
                                                                                collector.on('collect', async(i) => {
                                                                                    i.deferReply({ ephemeral: true }).catch(() => {});
                                                                                    player.play(interaction, axiosData.data.music_url)
