                    ...
                    setInterval(() => {
                        message.channel.messages.fetch(data.msgID).then(msg => {
                            ...
                            msg.edit({
                                embeds: [
                                    new MessageEmbed()
                                    .setAuthor(queue ? queue.songs[0].name : "No song playing currently")
                                    .setColor(colors.done)
                                    .setImage(queue ? queue.songs[0].thumbnail : "https://media.discordapp.net/attachments/743880363331420241/902711609112264804/unknown.png")
